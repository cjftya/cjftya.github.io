...
export const GEOMETRY_PROFILES: Readonly<Record<string, ProfileInput>> = {
  ...
  'flavivirus-smooth-envelope': profile('enveloped', {
    radius: 2.02,
    unitCount: 72,
    spikeCount: 72,
    protrusion: 0.08,
  ...
  'pneumovirus-rsv-rnp': profile('enveloped', {
    radius: 2.12,
    unitCount: 48,
    spikeCount: 66,
    protrusion: 0.28,
  ...
  'arenavirus-lassa-segmented': profile('enveloped', {
    radius: 2.08,
    unitCount: 42,
    spikeCount: 42,
    protrusion: 0.28,
  ...
  'hepacivirus-lipoviroparticle': profile('enveloped', {
    radius: 1.92,
    unitCount: 28,
    spikeCount: 28,
    protrusion: 0.22,
  ...
  'rubivirus-envelope-core': profile('enveloped', {
    radius: 1.94,
    unitCount: 48,
    spikeCount: 48,
    protrusion: 0.26,
  ...
  'bullet-rabies': profile('enveloped', {
    radius: 1.75,
    elongation: 1.8,
    unitCount: 32,
    spikeCount: 34,
  ...
  'influenza-h1n1pdm09': profile('enveloped', {
    radius: 2.1,
    unitCount: 28,
    spikeCount: 46,
    protrusion: 0.34,
  ...
  'influenza-h5n1': profile('enveloped', {
    radius: 2.12,
    unitCount: 28,
    spikeCount: 48,
    protrusion: 0.35,
  ...
  'enveloped-alphavirus-chikungunya': profile('enveloped', {
    radius: 1.98,
    unitCount: 44,
    spikeCount: 60,
    protrusion: 0.27,
  ...
  'ico-poliovirus-1': profile('icosahedral', {
    radius: 1.58,
    unitCount: 42,
    unitScale: 0.15,
    protrusion: 0.05,
  }),
  'ico-hepatitis-a': profile('icosahedral', {
    radius: 1.56,
    unitCount: 42,
    unitScale: 0.15,
    protrusion: 0.04,
