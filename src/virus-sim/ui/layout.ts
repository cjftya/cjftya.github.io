  ...
  root.innerHTML = `
    <div class="virus-app">
      <header class="app-header">
        ...
        <div class="brand-block"><span class="eyebrow">v4.8.4</span><h1>Virus Sim</h1></div>
    ...
    <dialog id="model-guide" class="model-guide">
      ...
      <div class="source-links"><a href="https://www.rcsb.org/" target="_blank" rel="noopener noreferrer">RCSB PDB ↗</a><a href="https://www.ebi.ac.uk/emdb/" target="_blank" rel="noopener noreferrer">EMDB ↗</a><a href="https://ictv.global/report" target="_blank" rel="noopener noreferrer">ICTV Report ↗</a></div>
    </dialog>`;
}
