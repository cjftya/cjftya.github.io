class MainScene extends AbsScene {
    ...
    onPreload() {
        TopicManager.ready().write(RESOURCE.DATA, new ResourceLoader()
            ...
            .add(ResourcePath.Thumbnail1, ResourceType.Image, ThreadType.Background)
            .add(ResourcePath.Thumbnail2, ResourceType.Image, ThreadType.Background)
            .add(ResourcePath.Thumbnail3, ResourceType.Image, ThreadType.Background)
            .add(ResourcePath.Thumbnail4, ResourceType.Image, ThreadType.Background)
            .add(ResourcePath.Thumbnail5, ResourceType.Image, ThreadType.Background)
            .add(ResourcePath.Thumbnail6, ResourceType.Image, ThreadType.Background)
            .add(ResourcePath.Thumbnail7, ResourceType.Image, ThreadType.Background)
            .add(ResourcePath.Thumbnail8, ResourceType.Image, ThreadType.Background)
            .add(ResourcePath.Thumbnail9, ResourceType.Image, ThreadType.Background)
            .add(ResourcePath.Thumbnail10, ResourceType.Image, ThreadType.Background)
            .add(ResourcePath.Thumbnail11, ResourceType.Image, ThreadType.Background)
            .add(ResourcePath.Thumbnail12, ResourceType.Image, ThreadType.Background)
